...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Joined as an early CV/ML hire and grew into a senior member of the software team; architected the production framework and MLOps for automated microscopy and scientific image processing from day one, cutting day-long experiments to under an hour (incl.\ a 141\,$\to$\,19 min pipeline step, 7$\times$ speedup).
...
\cventry{2016}{2017}
  ...
  {\small\textit{Early-stage Computer Vision startup, Tehran.}\\[1mm]
    ...
    \tabitem Built DevOps and internal engineer-experience tooling from scratch to accelerate R\&D; developed FaraTraffic, a vehicle detection and traffic analysis system with 5+ years of production uptime.%
  }
