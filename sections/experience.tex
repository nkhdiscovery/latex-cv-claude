...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{1.5mm} \\
    \small
      \tabitem Deliver cross-functional features across the full instrument stack, tracing how bench changes propagate through the imaging pipeline to spatial proteomics results.
      ...
      \tabitem Own quarterly EC2 spend audits, deprecating, deleting, or archiving to Glacier for low-hanging savings; cut AWS costs by \$150K and keep cloud spend intentional and defensible.%
  \end{tabularx}%
}\\
