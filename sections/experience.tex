...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{1.5mm} \\
    \small
      \tabitem Deliver cross-functional features across the full platform stack, tracing how lab bench changes propagate through the imaging pipeline to spatial proteomics results.
      ...
      \tabitem Deliver mission-critical features across a mix of R\&D and productionisation; own observability and DevSecOps: QA/QC, environment standardisation, and containerisation.
...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \small
      ...
      \tabitem Applied that framework to train and adapt transformer and heavy vision models for our spatial proteomics drug discovery use cases, running 90+ training and evaluation runs in two months to identify the best-fit architectures.%
  \end{tabularx}%
}\\
\multicolumn{2}{c}{}\vspace{1mm}\\
