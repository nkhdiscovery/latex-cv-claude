...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \small
      ...
      \tabitem Own observability and DevSecOps: design QA/QC across experiments, and drive environment standardisation, containerisation, and infrastructure automation for instrument control.
...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Product owner and technical lead for a first-of-its-kind spatial proteomics instrument with no prior art; coached a multidisciplinary team (optics, chemistry, biology, robotics, software) through pairing, code review, and 1:1s to align on architecture decisions.
...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Joined as first CV/ML hire; stood up observability and experiment QA/QC from day one, then architected the production framework, MLOps, and Ansible automation for automated microscopes, built from the ground up.
