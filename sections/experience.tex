...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \small
      ...
      \tabitem Coach-player across a multidisciplinary team (biochemistry, optics, robotics, software): pairing, code review for architecture alignment, and 1:1s; facilitate research--engineering collaboration aligned with company vision.
      \tabitem Own observability and DevSecOps: design QA/QC across experiment design and post-analysis; drive environment standardisation, containerisation, and tooling (incl.\ AI/agentic development tooling adopted over the past year); maintain Ansible infrastructure and state machine-driven instrument automation.
...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Owned product management and technical direction for a first-of-its-kind spatial proteomics instrument with no prior art; navigated unknown unknowns across optics, chemistry, biology, robotics, and software as coach-player --- pairing, code review, and 1:1s to align the team on architecture decisions.
...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Joined as first CV/ML hire; stood up observability and experiment QA/QC from day one, then architected the production framework, MLOps, and Ansible automation for automated microscopes --- built it from the ground up.
      \tabitem Bridged drug discovery science and software: researched transformers and heavy models from literature, drove code review for architecture alignment; 90+ evaluations in two months via a plugin-based MLOps framework enabling modular experiment design.
...
\cventry{2016}{2017}
  ...
  {\small\textit{Early-stage Computer Vision startup, Tehran.}\\[1mm]
    \tabitem Built DevOps and internal engineer-experience tooling from scratch to accelerate R\&D, plus a network-configurable CV Engine in C++ underpinning all products; developed FaraTraffic (vehicle detection, traffic analysis, 5+ years production uptime).%
  }
