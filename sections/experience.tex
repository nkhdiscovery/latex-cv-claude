...
\multicolumn{1}{l}{%
  \begin{tabularx}{0.9\textwidth}{@{}X@{}}
    ...
    \vspace{2mm} \\
    \small
      \tabitem Joined as an early CV/ML hire and grew into a senior member of the software team; architected the production framework, MLOps, observability, QA/QC, and Ansible automation for automated microscopy from day one.
      ...
      \tabitem Bridged drug discovery science and software: researched transformers and heavy models from literature, drove code review for architecture alignment; 90+ evaluations in two months.
